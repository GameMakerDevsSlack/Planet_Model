...
var _flip_normals = argument1;
var _flip_UVs     = argument2;
var _offset_x     = argument3;
var _offset_y     = argument4;
var _offset_z     = argument5;
...
var _buffer = buffer_create( _size*36, buffer_fixed, 1 );
for( var _i = 0; _i < _size; _i++ ) {
	...
	buffer_write( _buffer, buffer_f32, _vx ); //3D position
	buffer_write( _buffer, buffer_f32, _vy );
	buffer_write( _buffer, buffer_f32, _vz );
		
	buffer_write( _buffer, buffer_u32, $FFFFFFFF ); //colour
		
	buffer_write( _buffer, buffer_f32, _tx ); //UV
	buffer_write( _buffer, buffer_f32, _ty );
		
	buffer_write( _buffer, buffer_f32, _nx ); //normal
	buffer_write( _buffer, buffer_f32, _ny );
	buffer_write( _buffer, buffer_f32, _nz );
	/*
