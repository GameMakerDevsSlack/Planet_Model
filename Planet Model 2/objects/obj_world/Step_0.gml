...
//*
if ( keyboard_check( ord( "W" ) ) ) rot_x_speed += 0.25;
if ( keyboard_check( ord( "S" ) ) ) rot_x_speed -= 0.25;
if ( keyboard_check( ord( "A" ) ) ) rot_z_speed += 0.25;
if ( keyboard_check( ord( "D" ) ) ) rot_z_speed -= 0.25;
if ( keyboard_check( ord( "Q" ) ) ) rot_y_speed -= 0.25;
if ( keyboard_check( ord( "E" ) ) ) rot_y_speed += 0.25;
rot_x_speed *= 0.85;
rot_y_speed *= 0.85;
rot_z_speed *= 0.85;
/*/
